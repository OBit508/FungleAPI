...
namespace FungleAPI.Role
{
    public class CustomRoleBehaviour : RoleBehaviour
    {
        ...
        public virtual RoleTypes GhostRole
        {
            get
            {
                if (IRole.Team == ModdedTeam.Crewmates)
                {
                    return RoleTypes.CrewmateGhost;
                }
                else if (IRole.Team == ModdedTeam.Impostors)
                {
                    return RoleTypes.ImpostorGhost;
                }
                return CustomRoleManager.NeutralGhost;
            }
        }
        public virtual RoleTaskHintType HintType => RoleTaskHintType.TaskHint;
        public virtual Color OutlineColor => IRole.RoleColor;
        public virtual bool ShowTeamColor => false;
        public virtual void MurderPlayer(PlayerControl target, CustomDeadBody deadBody)
        {
        }
