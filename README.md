...
Fungle API is a modding framework for Among Us, heavily inspired by both Mira API and Reactor. It provides a wide range of tools and systems designed to simplify mod development and extend the game's capabilities.
